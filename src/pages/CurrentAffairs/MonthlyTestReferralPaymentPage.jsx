...
const MonthlyTestReferralPaymentPage = () => {
  ...
  useEffect(() => {
    ...
    const verifyReferrer = async (id) => {
      try {
        const localUser = localStorage.getItem("user");
        const userData = localUser ? JSON.parse(localUser) : null;
        const studentId = userData ? userData.id : '';
        const BASE_URL = import.meta.env.VITE_BASE_URL;
        const response = await axios.get(`${BASE_URL}api/CurrentAffairs/verify_referrer.php?referrer_id=${id}&student_id=${studentId}`);
  ...
  if (isValidatingReferrer) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 font-medium">Verifying referral link...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
        <motion.div
          ...
          className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 text-center"
        >
          <div className="w-16 h-16 bg-red-50 dark:bg-red-900/20 text-red-650 dark:text-red-400 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl">
            😊
          </div>
          {isAlreadyActive ? (
            <>
              <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">Action Not Allowed</h2>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-4 leading-relaxed font-semibold">
                You cannot refer or buy the course again until expiry 😊
              </p>
            </>
          ) : (
            <>
              <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">Invalid Referral Link</h2>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-8 leading-relaxed font-semibold">
                The referral link you used is invalid, or the student who referred you does not have an active subscription. You can still purchase the Premium Monthly Test directly.
              </p>
              <button
                onClick={() => navigate('/premium-monthly-test')}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl transition-all shadow-md hover:shadow-lg"
              >
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white h-full">
              <div className="p-8 md:p-12">
                <div className="space-y-3 mb-8">
                  ...
                  <span>BUY CURRENT AFFAIRS TEST (REFERRAL OFFER)</span>
                </h1>
                ...
                <p className="text-base md:text-lg font-semibold flex items-start gap-3 text-yellow-300">
                  <span className="text-xl">🎁</span> 
                  <span>Includes +1 Day Referral Reward Extension*</span>
                </p>
              </div>
            ...
            {isGeneratingInvoice ? (
              <div className="p-8 md:p-12 flex flex-col justify-center items-center min-h-[400px]">
               ...
               <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                {referrerId && (
                  <div className="mb-6 p-4 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-xl text-green-800 dark:text-green-300 text-sm font-semibold flex items-center gap-3 shadow-sm">
                    <span className="text-xl">😊</span>
                    <span>This is a referral from your friend! You will get extended validity because your friend referred you.</span>
                  </div>
                )}
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
                    ...
                    <span className="font-bold text-lg dark:text-white">₹10</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
                    ...
                    <span className="font-bold text-lg dark:text-white">Extended Validity</span>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mb-8">
                  ...
                  <div className="flex justify-between items-center text-xl font-bold">
                    ...
                    <span className="text-blue-600 dark:text-blue-400">₹10.00</span>
                  </div>
                </div>
...
export default MonthlyTestReferralPaymentPage;
