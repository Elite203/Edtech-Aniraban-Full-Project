...
.e-rte-quick-popup.e-rte-elements {
  -webkit-box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.16), 0 4px 6px -1px rgba(0, 0, 0, 0.14);
          box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.16), 0 4px 6px -1px rgba(0, 0, 0, 0.14);
}
.e-rte-quick-popup.e-rte-elements .e-rte-quick-toolbar.e-rte-toolbar.e-toolbar {
  background: #fff;
}
...
.e-bigger .e-rte-quick-popup .e-rte-tip-pointer.e-rte-tip-top::before {
  ...
  border-bottom: 14px solid #ced4da;
}
