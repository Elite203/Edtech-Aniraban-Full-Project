...
.e-rte-quick-popup .e-rte-tip-pointer.e-rte-tip-top::before {
  ...
  border-bottom: 10px solid var(--color-sf-border-secondary);
}
.e-rte-quick-popup .e-rte-tip-pointer.e-rte-tip-top::after {
  border-left: 7.5px solid transparent;
  border-right: 7.5px solid transparent;
  border-bottom: 9px solid var(--color-sf-bg-secondary);
}
.e-rte-quick-popup .e-rte-tip-pointer.e-rte-tip-bottom::before {
  border-left: 8px solid transparent;
  border-right: 8px solid transparent;
  border-top: 10px solid var(--color-sf-border-secondary);
}
...
.e-bigger .e-dialog.e-rte-table-popup.e-popup.e-popup-open {
  min-height: 164px !important; /* stylelint-disable-line declaration-no-important */
}
