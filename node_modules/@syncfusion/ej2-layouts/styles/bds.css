...
.e-card {
  -webkit-tap-highlight-color: var(--color-sf-brand-primary);
...
.e-timeline .e-dot {
  background-color: rgba(var(--color-sf-border-secondary));
  border-color: rgba(var(--color-sf-border-secondary));
  color: var(--color-sf-text-tertiary);
  outline-color: var(--color-sf-bg-primary);
}
