...
// node_modules/textify.js/src/utils/Break.js
...
// node_modules/textify.js/src/utils/Text.js
var _document;
var _window;
var _coreInitted;
var _stripExp = /(?:\r|\n|\t\t)/g;
...
var _getComputedStyle = (element) => _window.getComputedStyle(element);
var _isArray = Array.isArray;
var _slice = [].slice;
var _toArray = (value, leaveStrings) => {
  let type;
  return _isArray(value) ? value : (type = typeof value) === "string" && !leaveStrings && value ? _slice.call(_document.querySelectorAll(value), 0) : value && type === "object" && "length" in value ? _slice.call(value, 0) : value ? [value] : [];
};
...
var customStyle = " style='position:relative;display:inline-block;'";
var cssClass = (cssClass2 = "", tag) => {
  let iterate = ~cssClass2.indexOf("++"), num = 1;
  if (iterate) {
    cssClass2 = cssClass2.split("++").join("");
  }
  return () => "<" + tag + customStyle + (cssClass2 ? " class='" + cssClass2 + (iterate ? num++ : "") + "'>" : ">");
};
...
var _splitRawText = (element, vars, wordStart, charStart) => {
  let tag = vars.tag ? vars.tag : vars.span ? "span" : "div", types = vars.type || vars.split || "chars,words,lines", chars = ~types.indexOf("chars"), absolute = _isAbsolute(vars), wordDelimiter = vars.wordDelimiter || " ", space = wordDelimiter !== " " ? "" : absolute ? "&#173; " : " ", wordEnd = "</" + tag + ">", wordIsOpen = 1, specialChars = vars.specialChars ? typeof vars.specialChars === "function" ? vars.specialChars : _findSpecialChars : null, text, splitText, i, j, l, character, hasTagStart, testResult, container = _document.createElement("div"), parent = element.parentNode;
...
var Splitter = class _Splitter {
  ...
  _split(vars) {
    ...
    let i = this.elements.length, tag = vars.tag ? vars.tag : vars.span ? "span" : "div", wordStart = cssClass(vars.wordsClass, tag), charStart = cssClass(vars.charsClass, tag), origHeight, origWidth, e;
    while (--i > -1) {
      e = this.elements[i];
  ...
  static create(element, vars) {
    return new _Splitter(element, vars);
  }
};

// node_modules/textify.js/src/utils/isBrowser.js
...
// node_modules/textify.js/src/types/Texts.js
var Texts = class {
  /**
   * @constructor
...
// node_modules/textify.js/src/utils/Config.js
var Config = {
...
// node_modules/textify.js/src/utils/Dom.js
...
// node_modules/textify.js/src/index.js
...
//# sourceMappingURL=textify__js.js.map
